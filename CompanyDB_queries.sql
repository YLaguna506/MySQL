...
Select first_name AS forname, last_name AS surname -- changes columns names
FROM employee;
...
-- Find averegae of all employee salaries
SELECT AVG(salary)
FROM employee;
...
-- FIND ANY BRANCH SUPPLIER IN LABEL BUSINESS
SELECT *
...
-- FULL OUTER JOIN = LEFT AND RIGHT JOIN TOGETHER


-- NESTED QUERIES

-- FIND NAMES OF ALL EMPLOYEES WHO
-- HAVE SOLD OVER 20K TO 1 CLIENT
...
-- ON DELETE CASCADE 
-- ON DELETE SET NULL EXPLANATION
